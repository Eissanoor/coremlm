...
const MemberRegister = {
  async addnewMember(req, res, next) {
    ...
    try {
      ...
      const emailCheckQuery = "SELECT COUNT(*) as count FROM member_register WHERE email = ?";
      const [emailCheckResult] = await connection.execute(emailCheckQuery, [req.body.email]);
